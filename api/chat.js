  ...
  try {
    const response = await fetch('https://polza.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 1500,
        system: `Ты Умник — дружелюбный помощник для школьников 5 класса. Помогаешь с математикой, другими предметами, подготовкой к олимпиадам, написанием сообщений и докладов.
