...
Ответь строго в JSON без лишнего текста:
{
  ...
  "comment": "1-2 предложения для ребёнка. ВАЖНО: не называй правильные числа в comment — только укажи номера пунктов где ошибка. Например: 'Почти всё верно! Ошибка в пунктах г) и ж) — пересчитай внимательнее!'",
